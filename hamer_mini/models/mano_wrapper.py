# Original code: https://github.com/geopavlakos/hamer/blob/main/hamer/models/mano_wrapper.py
import contextlib
import io
import torch
import numpy as np
...
class MANO(smplx.MANOLayer):
    def __init__(self, *args, joint_regressor_extra: Optional[str] = None, **kwargs):
        ...
        """
        # smplx prints 'WARNING: You are using a MANO model, with only 10 shape
        # coefficients.' to stdout; that is simply how MANO is defined, so hide it.
